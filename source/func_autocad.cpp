...
int CDOSLibApp::ads_dos_hatcharea()
{
  ...
  {
    double area = 0.0;
#if defined(ARX21) || defined(ARX22) || defined(ARX23) || defined(ARX24) || defined(ZRX20) || defined(ZRX21) || defined(ZRX22)
...
#if defined(ARX23) || defined(ARX24) || defined(ZRX21) || defined(ZRX22)
